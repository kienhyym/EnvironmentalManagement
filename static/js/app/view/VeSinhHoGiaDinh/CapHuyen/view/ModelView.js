define(function (require) {
	...
	var template = require('text!app/view/VeSinhHoGiaDinh/CapHuyen/tpl/model.html'),
		schema = require('json!schema/VSCapHuyenSchema.json');


	var schema_tong = require('json!app/view/VeSinhHoGiaDinh/CapHuyen/view/TongiSchema.json');
	var template_tong = require('text!app/view/VeSinhHoGiaDinh/CapHuyen/tpl/tongcongi.html');
