define(function (require) {
	...
	var template = require('text!app/view/VeSinhHoGiaDinh/CapTinh/tpl/model.html'),
		schema = require('json!schema/VSCapTinhSchema.json');


	var schema_tong = require('json!app/view/VeSinhHoGiaDinh/CapTinh/view/TongiSchema.json');
	var template_tong = require('text!app/view/VeSinhHoGiaDinh/CapTinh/tpl/tongcongi.html');
