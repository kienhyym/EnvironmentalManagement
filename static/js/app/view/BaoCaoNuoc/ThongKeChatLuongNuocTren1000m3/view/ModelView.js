define(function (require) {
	...
	var template = require('text!app/view/BaoCaoNuoc/ThongKeChatLuongNuocTren1000m3/tpl/model.html'),
		schema = {};
		...
		render: function () {
			...
			if (!!currentUser && !!currentUser.donvi) {
				...
				self.$el.find("#search").unbind("click").bind("click", function () {
					...
					var url = self.getApp().serviceURL + "/api/v1/thongkenuocsach_tren1000m3?nambaocao="
