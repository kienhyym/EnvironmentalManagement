define(function (require) {
	...
	var template = require('text!app/view/BaoCaoPhuLuc5/BanGiaoDuLieuDaThuThap/tpl/model.html'),
	schema = require('json!schema/BanGiaoDuLieuDaThuThapSchema.json');
	var BanGiaoThuThapView = require('app/view/BaoCaoPhuLuc5/BanGiaoThuThap/view/ModelDialogView');
		                	...
		                	tools:[
	        	                 {
	        	                	 ...
	        	                	 command: function(){
	        	                		 var self = this;
	                	    			 var view = new BanGiaoThuThapView({"viewData":{"id":null,"baocao_id":self.model.get("id")}});
	        	                		 view.dialog();
	        	                		 view.on('close',function(data){
	        	                			 var bangiaothuthap = self.model.get('bangiaothuthap');
	        	                			 bangiaothuthap.push(data);
	        	                			 self.model.set("bangiaothuthap",bangiaothuthap);
	        	                			 self.applyBindings();
	        	                		 });
	        	                	 }
	        	                 }
